...
class HttpClient
{
	...
	public function __construct($options=array())
	{
		...
		$this->methods = array('GET', 'POST', 'HEAD', 'DELETE');
	}
	...
	private function createThread($request)
	{
		...
		if (isset($request['options']['ssl']))
		{
			// $options[CURLOPT_SSLCERT]  = $request['options']['ssl'];
			// $options[CURLOPT_CAINFO]  = $request['options']['ssl'];
		}

		if (isset($request['options']['ssltype']))
		{
			// $options[CURLOPT_SSLCERTTYPE]  = $request['options']['ssltype'];
			// $options[CURLOPT_SSLKEYTYPE]  = $request['options']['ssltype'];
		}
